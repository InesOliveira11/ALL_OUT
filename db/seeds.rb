...
question_1 = Question.create(question: 'Do you want to be...', answer_1: "Indoors", next_question_1: last_question_id + 2, answer_2: "Outdoors", next_question_2: last_question_id + 3)
p question_1
